...
// import {ZERO_BOUNCE_API_KEY, MAILBOXLAYER_API_KEY } from './const/constants';
...
function App() {
    ...
    return (
        <div>
            {
                currentPage === 'Content' ?
                    <Content scheduleAction={() => setCurrentPage('Schedule')} backAction={() => setCurrentPage('Home')} username={username} email={email} />
                    : <Home goAction={async () => {
                        if (!username) {
